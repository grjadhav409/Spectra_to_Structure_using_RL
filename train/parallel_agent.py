...
class EpisodeActor(object):
    def __init__(self):
        ...
        try:
            with open('/ssd_scratch/users/sriram.devata/ir_cache_' +  str(self.idx) + '.pkl', 'rb') as handle:
        ...
        if smiles in self.cached_ir_forward:
            ...
            if self.cached_ir_size < 1000: # don't add spectra to cache after these many spectra
                ...
                if self.new_spectra > 50:
                    ...
                    with open('/ssd_scratch/users/sriram.devata/ir_cache_' +  str(self.idx) + '.pkl', 'wb') as handle:
